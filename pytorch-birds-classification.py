...
import os
for dirname, _, filenames in os.walk('./CUB_200_2011/CUB_200_2011'):
...
(train_loader, val_loader, test_loader), classes = get_data_loaders("./CUB_200_2011/CUB_200_2011/images/", 64)
